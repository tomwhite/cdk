...
import com.cloudera.cdk.data.spi.RangePredicates;
...
public class TestFileSystemPartitionIterator extends MiniDFSTest {
  ...
  public void testFromKey() throws Exception {
    ...
    Iterable<Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.from(comparator, october_24_2013));
  ...
  public void testAfterKey() throws Exception {
    Marker october_24_2013 = new Marker.Builder().add("year", 2013).add("month", 10).add("day", 24).build();
    Iterable<Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.fromAfter(comparator, october_24_2013));
  ...
  public void testToKey() throws Exception {
    ...
    Iterable<Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.to(comparator, october_25_2012));
  ...
  public void testBeforeKey() throws Exception {
    Marker october_25_2012 = new Marker.Builder().add("year", 2012).add("month", 10).add("day", 25).build();
    Iterable <Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.toBefore(comparator, october_25_2012));
  ...
  public void testInKey() throws Exception {
    Marker october_24_2013 = new Marker.Builder().add("year", 2013).add("month", 10).add("day", 24).build();
    Iterable<Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.of(comparator, october_24_2013));
  ...
  public void testFromMarker() throws Exception {
    ...
    Iterable <Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.from(comparator, october_2013));
  ...
  public void testAfterMarker() throws Exception {
    Marker october_2013 = new Marker.Builder().add("year", 2013).add("month", 10).build();
    Iterable<Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.fromAfter(comparator, october_2013));
  ...
  public void testToMarker() throws Exception {
    ...
    Iterable <Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.to(comparator, october_2012));
    assertIterableEquals(keys.subList(0, 6), partitions);
  }
  ...
  public void testBeforeMarker() throws Exception {
    Marker october_2012 = new Marker.Builder().add("year", 2012).add("month", 10).build();
    Iterable<Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.toBefore(comparator, october_2012));
  ...
  public void testInMarker() throws Exception {
    Marker october_2012 = new Marker.Builder().add("year", 2012).add("month", 10).build();
    Iterable<Key> partitions = new FileSystemPartitionIterator(
        fileSystem, testDirectory, strategy, RangePredicates.of(comparator, october_2012));
