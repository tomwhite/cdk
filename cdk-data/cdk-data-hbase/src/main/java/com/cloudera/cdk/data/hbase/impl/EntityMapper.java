...
/**
 * An interface for mapping HBase Result instances to a CompleteKey/Entity pair, and a
 * CompleteKey/Entity to an HBase Put instances.
 * 
...
public interface EntityMapper<E> {
  ...
  /**
   * Map an HBase Result instance to an Entity of type T. Retrieve the CompleteKey from
   ...
   * @return A KeyEntity instance which wraps a CompleteKey and an Entity of type T.
   */
  public E mapToEntity(Result result);

  /**
   * Map a CompleteKey and an entity of type T to an HBase Put instance.
   * 
   * @param key
  ...
  /**
   * Maps a CompleteKey, fieldName and an increment value to an HBase Increment instance
