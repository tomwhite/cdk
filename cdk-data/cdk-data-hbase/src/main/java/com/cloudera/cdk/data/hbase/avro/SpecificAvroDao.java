 ...
 * 
 * @param <K>
 *          The CompleteKey's underlying record type.
 * @param <E>
 *          The entity type.
 */
public class SpecificAvroDao<E extends SpecificRecord> extends BaseDao<E> {
   ...
   *          The Avro schema string that represents the CompleteKey structure for row
   *          keys in this table.
   ...
   * @param keyClass
   *          The class of the SpecificRecord representing the CompleteKey of rows this
   *          dao will fetch.
   * @param entityClass
   *          The class of the SpecificRecord this DAO will persist and fetch.
   ...
   *          The table name this dao will read from and write to
   * @param keySchemaStream
   *          The Avro schema input stream that represents the CompleteKey structure for
