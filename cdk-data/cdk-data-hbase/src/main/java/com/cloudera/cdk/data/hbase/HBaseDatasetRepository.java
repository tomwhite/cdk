...
public class HBaseDatasetRepository extends AbstractDatasetRepository<MapDataset> {
...
//      }
  ...
  static boolean isComposite(DatasetDescriptor descriptor) {
    ...
    return parser.parseEntity(entitySchema).getFieldMappings().isEmpty();
  }
