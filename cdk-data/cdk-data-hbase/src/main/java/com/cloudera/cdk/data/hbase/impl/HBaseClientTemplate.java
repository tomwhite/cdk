...
public class HBaseClientTemplate {
   ...
   * 
   * @param key
   *          The CompleteKey to create a Get from.
   * @param entityMapper
   ...
   * 
   * @param key
   *          The CompleteKey to map to a Put with the entityMapper.
   * @param entity
  ...
  /**
   * Refactored the key subsystem by removing the "CompleteKey" wrapper type, Get an
